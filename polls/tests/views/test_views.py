...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        index page.
        """
        question = _create_question(question_text="Past question.", days=-30)
        response = self.client.get(reverse("polls:index"))
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = _create_question(question_text="Past question 1.", days=-30)
        question2 = _create_question(question_text="Past question 2.", days=-5)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
            response.context["object_list"],
            [question2, question1],
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        """
        future_question = _create_question(question_text="Future question.", days=5)
    ...
    def test_past_question(self):
        ...
        """
        past_question = _create_question(question_text="Past Question.", days=-5)
